    ...
    <footer className="border-t border-border bg-background">
      <div className="container-safe py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-lg">Stich</span>
            </div>
            <p className="text-sm text-muted-foreground">
              AI-powered web application generator built with Vercel and Firebase.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              <Link to="/docs" className="block text-sm text-muted-foreground hover:text-foreground">
                Documentation
              </Link>
        ...
        <div className="mt-8 pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © 2025 Stich Production. All rights reserved.
          </p>
